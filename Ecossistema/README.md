...
| BitUp | Nível | Conteúdos Relacionados | Link |
|-------|-------|------------------------|------|
| 🪙 **BitUp 1 — Carteiras Bitcoin Core** | Gênese → Satoshi | Bitcoin CLI e RPC | [Acessar o curso](https://bitcoincoders.org/curso/carteiras-bitcoin-core) |
| 🔄 **BitUp 2 — Transações Bitcoin Core** | Satoshi | Bitcoin CLI e RPC + bitcoinjs-lib/python-bitcoinlib | [Acessar o curso](https://bitcoincoders.org/curso/transacoes-bitcoin-core) |
| 🧠 **BitUp 3 — Scripts Bitcoin** | Satoshi → Core | Scripts, assinaturas e automação | [Acessar o curso](https://bitcoincoders.org/curso/scripts-bitcoin) |
