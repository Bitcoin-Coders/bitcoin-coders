...
## 🕰️ As Eras do Bitcoin Coders

| Era | Foco | Descrição |
|------|------|------------|
| 🧬 [**Era Gênese**](https://github.com/Bitcoin-Coders/era-genese) | Fundamentos | Base técnica para o desenvolvimento Bitcoin: Transformações de bases numéricas, Criptografia aplicada, Estruturas de dados e algoritmos para blockchain, Programação concorrente e assíncrona, Redes P2P e consenso distribuído. |
...
Cada pasta (repositório) é autônoma, com seus próprios artigos, vídeos, bitups e scripts.
